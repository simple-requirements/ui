Feature: Workspace UX
    ...
    Scenario: The first project in the list is automatically selected
        ...
        Then the "Requirements Platform" project is selected
    ...
    Scenario: Looking for a specific requirement
        Given the workspace layout is open
        When I enter "FR-INT-0002" into the search field
        And I "click" on the "Find key" button
        Then the requirement "FR-INT-0002" is selected
    ...
    Scenario: New Project form shows user-safe errors and clear actions
        ...
        And I submit the "New Project" form with "Contract Gap Project"
        Then I see a user-safe error message: "Project creation is currently unavailable."
    ...
    Scenario: New Requirement form has stable field layout
        Given the workspace layout is open
        When I "click" on the "New requirement" button
        Then the "New requirement" form shows active project "Requirements Platform"
    ...
    Scenario: Requirement tabs have accessible and visible close controls
        Given the workspace layout is open
        When I select requirement "FR-INT-0002"
        And I "click" on the "Open in tab" button
        Then the requirement tab "FR-INT-0002" is visible
        And the "Workspace" tab has no close button
        When I close the requirement tab "FR-INT-0002"
