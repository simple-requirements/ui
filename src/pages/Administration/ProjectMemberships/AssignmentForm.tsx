...
export function AssignmentForm({
  ...
  const addDisabled =
    controlsDisabled || selectedUserId.length === 0 || selectedRoles.length === 0;
  ...
  function addMembership(event: SyntheticEvent<HTMLFormElement>): void {
  ...
  return (
    ...
    >
      ...
      <fieldset className="project-memberships__roles" disabled={controlsDisabled}>
