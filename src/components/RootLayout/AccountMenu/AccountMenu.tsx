...
export function AccountMenu() {
  ...
  return (
    <div className="account-menu" aria-label="Current user">
      ...
      />
      {open ? (
        <div id={ACCOUNT_MENU_ID} role="menu" className="account-menu__popup">
          <div className="account-menu__summary" aria-label="Signed in user">
          ...
          >
            <span className="pi pi-sign-out" aria-hidden="true" />
            Logout
          </button>
        </div>
      ) : null}
