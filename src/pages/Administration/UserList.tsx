...
export type UserListProps = Readonly<{
    ...
    pending: boolean;
    onOpenRoleDialog: (user: UserAdministrationResponse, loggedIn: boolean) => void;
    onChangeStatus: (user: UserAdministrationResponse, status: Exclude<UserStatus, 'pending'>) => void;
            ...
            <table className='user-administration__table'>
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            scope='col'
                            className='user-administration__actions-column'>
                            Actions
                        </th>
                    </tr>
                </thead>
                            ...
                            <tr key={user.id}>
                                ...
                                <td>
                                    <button
                                        ...
                                        disabled={pending || presence?.loading === true || presence?.error === true}
                                        title={
                                            presence?.loading === true ? 'Checking whether this user is logged in.'
                                            : presence?.error === true ?
                                ...
                                <td>
                                    <span
                                        ...
                                        aria-label={
                                            presence?.loading ? 'Login state loading'
                                            : presence?.error ?
                                        ...
                                        <i
                                            className={`pi ui-icon ${loggedIn ? 'pi-sign-in' : 'pi-sign-out'}`}
                                            aria-hidden='true'
                                        />
                                    </span>
                                </td>
                                <td>
                                    <div className='user-administration__row-actions'>
                                        <Button
                                            ...
                                            text
                                            rounded
                                            severity={targetStatus === 'deactivated' ? 'danger' : undefined}
                                            icon={targetStatus === 'deactivated' ? 'pi pi-ban' : 'pi pi-check-circle'}
                                            aria-label={
