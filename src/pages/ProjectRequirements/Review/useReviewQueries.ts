...
export function useReviewQueries(projectId: string | undefined, requirementId: string | undefined) {
    ...
    return {
        ...
        loading: requirementQuery.isLoading || commentsQuery.isLoading || summaryQuery.isLoading,
        error: requirementQuery.isError || commentsQuery.isError || summaryQuery.isError,
    };
}
