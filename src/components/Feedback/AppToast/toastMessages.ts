...
export const toastMessages = {
    ...
    userRoleChangeBlockedByLogin: (displayName: string): AppToastMessage => ({
        severity: 'error',
        summary: 'Account role cannot be changed',
        detail: `${displayName} is currently logged in and cannot be temporarily deactivated. Log the user out first.`,
        life: errorLife,
    }),
