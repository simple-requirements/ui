...
export const toastMessages = {
  ...
  implementationTicketSaved: (): AppToastMessage => ({
    severity: "success", summary: "Implementation ticket saved", detail: "The implementation ticket has been saved.", life: successLife,
  }),
  implementationTicketDeleted: (): AppToastMessage => ({
    severity: "success", summary: "Implementation ticket deleted", detail: "The implementation ticket has been deleted.", life: successLife,
  }),
  ticketSystemSettingsSaved: (): AppToastMessage => ({
    severity: "success", summary: "Ticket system settings saved", detail: "The project ticket URL template has been updated.", life: successLife,
  }),
  implementationActionFailed: (detail: string): AppToastMessage => ({
    severity: "error", summary: "Implementation action failed", detail, life: errorLife,
  }),
  ...
  userStatusChanged: (displayName: string, status: string): AppToastMessage => ({
    severity: "success",
    summary: "User status changed",
    detail: `${displayName} is now ${status}.`,
    life: successLife,
  }),
  userSessionRevoked: (): AppToastMessage => ({
    severity: "success",
    summary: "User session revoked",
    detail: "The selected user session has been revoked.",
    life: successLife,
  }),
  userSessionsRevoked: (): AppToastMessage => ({
    severity: "success",
    summary: "User sessions revoked",
    detail: "All active sessions for the selected user have been revoked.",
    life: successLife,
  }),
  userAdministrationFailed: (): AppToastMessage => ({
    severity: "error",
    summary: "User administration failed",
    detail: "The user administration change could not be completed.",
    life: errorLife,
  }),
