...
export const toastMessages = {
  ...
  userSessionRevoked: (): AppToastMessage => ({
    ...
    detail: "The selected session has been revoked.",
    life: successLife,
  }),
  userSessionsRevoked: (): AppToastMessage => ({
    severity: "success",
    summary: "Sessions revoked",
    detail: "All active sessions for the user have been revoked.",
    life: successLife,
  }),
  userAdministrationFailed: (): AppToastMessage => ({
    severity: "error",
    summary: "Administration action failed",
    detail: "The user administration action could not be completed.",
    life: errorLife,
  }),
} as const;
