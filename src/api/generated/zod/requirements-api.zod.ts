...
export const CompareRequirementRevisionsQueryParams = zod.object({ from: zod.string(), to: zod.string() });

export const CompareRequirementRevisionsResponse = zod.unknown();
