...
function includesProjectRole(roles: readonly ProjectRole[] | undefined, role: ProjectRole): boolean {
...
export function getProjectRoles(
    ...
    return getProjectMembership(user, projectId)?.roles ?? (user?.projectMemberships === undefined ? undefined : []);
}
...
function usesLegacyProjectMembershipFallback(user: AuthenticatedUser | undefined): boolean {
...
export function getProjectPermissions(
    ...
    const requirementsEngineer = includesProjectRole(roles, 'requirements_engineer');
