...
vi.mock("@/api/adminProjectsApi", () => ({
  listAdministratorProjects: mocks.listAdministratorProjects,
}));
...
describe("AdministratorSidebar", () => {
  it("expands Users & Sessions and renders all users as navigation children", async () => {
    ...
    expect(
      await screen.findByRole("link", { name: "Developer" }),
    ).toHaveAttribute(
      "href",
      "/admin/users/11111111-1111-4111-8111-111111111111",
    );
    expect(
      screen.getByRole("button", { name: /Users & Sessions/u }),
  ...
  it("expands Projects and renders all projects as navigation children", async () => {
    ...
    expect(
      await screen.findByRole("link", { name: /Project Alpha/u }),
    ).toHaveAttribute(
      "href",
  ...
  it("navigates to the section overview when a section is toggled", async () => {
    ...
    expect(screen.getByRole("button", { name: /Projects/u })).toHaveAttribute(
      "aria-expanded",
      "true",
    );
  });
