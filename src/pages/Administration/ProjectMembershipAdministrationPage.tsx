...
export function ProjectMembershipAdministrationPage() {
    ...
    const administration = useProjectMembershipAdministration(selectedProjectId);
    ...
    return (
        <section
            ...
            <header>
                <p className='project-membership-administration__eyebrow'>Administration</p>
                <h1 id='project-membership-administration-title'>Project memberships</h1>
            ...
            <LoadableContent
                ...
                :   <LoadableContent
                        loading={administration.usersLoading || administration.membershipsLoading}
                        ...
                        <ProjectMemberships
                            ...
                            onRemoveMembership={(userId, displayName) =>
                                administration.removeMembership({ projectId: selectedProject.id, userId, displayName })
                            }
                        />
                    </LoadableContent>
                }
