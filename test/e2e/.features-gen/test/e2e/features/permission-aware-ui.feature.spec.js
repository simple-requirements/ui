...
test.describe('Permission-aware frontend', () => {
  ...
  test('Administrator without project membership has global project administration but no requirement-content access', { tag: ['@permission-aware-ui'] }, async ({ Given, When, Then, And, page }) => { 
    await Given('the permission-aware frontend signs me in as "Administrator"', null, { page }); 
    await When('I try to open the permission test requirement details', null, { page }); 
    await Then('Administrator project administration navigation should be visible', null, { page }); 
    await And('requirement contents should not be visible', null, { page }); 
  });
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":30,"pickleLine":25,"tags":["@permission-aware-ui"],"steps":[{"pwStepLine":31,"gherkinStepLine":26,"keywordType":"Context","textWithKeyword":"Given the permission-aware frontend signs me in as \"Administrator\"","stepMatchArguments":[{"group":{"start":45,"value":"\"Administrator\"","children":[{"start":46,"value":"Administrator","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]},{"pwStepLine":32,"gherkinStepLine":27,"keywordType":"Action","textWithKeyword":"When I try to open the permission test requirement details","stepMatchArguments":[]},{"pwStepLine":33,"gherkinStepLine":28,"keywordType":"Outcome","textWithKeyword":"Then Administrator project administration navigation should be visible","stepMatchArguments":[]},{"pwStepLine":34,"gherkinStepLine":29,"keywordType":"Outcome","textWithKeyword":"And requirement contents should not be visible","stepMatchArguments":[]}]},
]; // bdd-data-end