...
export function RequirementDetailsList({ requirement }: RequirementDetailsListProps) {
    return (
        <dl className='requirement-details-panel__details-list'>
            <RequirementDetailsRow label='Key'>{requirement.visibleKey}</RequirementDetailsRow>
            ...
            <RequirementDetailsRow label='Owner'>{formatNullableValue(requirement.owner)}</RequirementDetailsRow>

            <RequirementDetailsRow label='Reviewer'>{formatNullableValue(requirement.reviewer)}</RequirementDetailsRow>
            ...
            <RequirementDetailsRow label='Source'>{formatNullableValue(requirement.source)}</RequirementDetailsRow>

            <RequirementDetailsRow label='Created'>{formatDateTime(requirement.createdAt)}</RequirementDetailsRow>

            <RequirementDetailsRow label='Updated'>{formatDateTime(requirement.updatedAt)}</RequirementDetailsRow>
