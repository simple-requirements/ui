...
test.describe('Projects', () => {
  ...
  test('New Project form creates a backend project', async ({ Given, When, Then, And, page }) => { 
    ...
    await And('the "New Project" form is closed', null, { page });
  });
