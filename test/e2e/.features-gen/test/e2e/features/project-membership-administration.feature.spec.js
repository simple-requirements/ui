...
test.describe('Project membership administration', () => {
  ...
  test('Assign and remove project memberships', { tag: ['@project-membership-administration'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await When('I assign "Developer" to the project', null, { page }); 
    await Then('"Developer" should have the project role "Developer"', null, { page }); 
