...
vi.mock("@/pages/ProjectDetails/useProjectDetails", () => ({
  useProjectDetails: mocks.useProjectDetails,
}));
vi.mock("@/pages/ProjectDetails/ProjectStatistics", () => ({
  ProjectStatistics: () => <div>Project statistics</div>,
}));
...
describe("ProjectDetailsPage", () => {
  it("links to requirements for a project-scoped user.", () => {
    ...
    ).toHaveAttribute("href", "/projects/project-alpha/requirements");
  });
});
