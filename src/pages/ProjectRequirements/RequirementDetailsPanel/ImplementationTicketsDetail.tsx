...
const statusesWithImplementationTickets: readonly Requirement["status"][] = [
  "approved",
  "implemented",
  "obsolete",
];
...
export type ImplementationTicketsDetailProps = Readonly<{
...
export function ImplementationTicketsDetail({
  requirement,
}: ImplementationTicketsDetailProps) {
