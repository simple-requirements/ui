...
export function UserAdministrationPage() {
    ...
    const selectedUser = administration.users.find((user) => user.id === selectedUserId);
            ...
            <LoadableContent
                ...
                <div className='user-administration__layout'>
                    ...
                    :   <UserDetails
                            ...
                            onChangeStatus={(status) => administration.changeStatus({ user: selectedUser, status })}
                            onRevokeSession={(sessionId) =>
                                administration.revokeSession({ userId: selectedUser.id, sessionId })
                            }
                            onRevokeAllSessions={() => administration.revokeAllSessions(selectedUser.id)}
                        />
                    }
                </div>
            </LoadableContent>
