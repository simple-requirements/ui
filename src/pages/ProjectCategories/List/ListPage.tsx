...
export function ListPage() {
    ...
    function handleEditCategory(category: CategoryTableRow): void {
    ...
    function handleAddRequirement(category: CategoryTableRow): void {
        if (projectId === undefined) {
            return;
        }
    ...
    function handleOpenCategory(category: CategoryTableRow): void {
        if (projectId === undefined) {
            return;
        }
    ...
    function handleOpenContextMenu(category: CategoryTableRow, event: MouseEvent): void {
