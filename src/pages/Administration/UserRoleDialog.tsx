...
export function accountRoleLabel(role: AccountRole | null): string {
    return roleOptions.find((option) => option.value === role)?.label ?? 'Not assigned';
}
...
export function UserRoleDialog({ user, visible, pending, onHide, onChangeRole }: UserRoleDialogProps) {
                ...
                <form
                    ...
                    <div className='user-role-dialog__field'>
                        ...
                        <select
                            ...
                            value={role}
                            disabled={pending}
                            onChange={(event) => setRole(event.currentTarget.value as AccountRole)}>
                            <option
                                value=''
                                disabled>
                                Select a role
