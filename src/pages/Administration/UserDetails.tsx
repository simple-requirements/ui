...
export function UserDetails({
    ...
    const statusActionLabel = user.status === 'active' ? 'Deactivate account' : 'Activate account';
    const activationBlocked = user.status !== 'active' && user.emailVerifiedAt === null;
        ...
        <section
            ...
            <dl className='user-administration__metadata'>
                ...
                <div>
                    ...
                    <dd>{user.emailVerifiedAt === null ? 'No' : formatDateTime(user.emailVerifiedAt)}</dd>
                </div>
                <div>
                    <dt>Created</dt>
            ...
            />
            {activationBlocked && (
                <p className='user-administration__hint'>The email address must be verified before activation.</p>
            )}
