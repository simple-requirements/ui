...
import type { AccountRole, AuthenticatedUser, ProjectRole, UserStatus } from '@/auth/authTypes';
...
export function updateUserRole(
    ...
    return apiFetch(`/admin/users/${encodeURIComponent(userId)}/role`, jsonRequest('PATCH', { role }));
}
